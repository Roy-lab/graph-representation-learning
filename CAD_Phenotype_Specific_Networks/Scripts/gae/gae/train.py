...
for cell in cells:
    print(cell)
    my_data = genfromtxt('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/adj_matrix/{}_no_weight.txt'.format(cell), delimiter=' ')
    print(my_data.shape)
    ...
    ids = range(num_nodes)
    with open("/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Results/embeddings/vgae_{}d/{}_features.emb".format('64', cell), "w") as f:
