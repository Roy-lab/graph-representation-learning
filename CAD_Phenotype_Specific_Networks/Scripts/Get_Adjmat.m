function Get_Adjmat()
    ...
    for i = 1:length(cells)
        ...
        newadj = adjmat * adjmat';
        
        writematrix(newadj, sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/adj_matrix/%s.txt',cell), 'Delimiter', ' ');
    end
end