function Get_Edeglist()
    ...
    for i = 1:length(cells)
        ...
        G = graph(adjmat * adjmat');
        edges = G.Edges; 
        
        writetable(edges, sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/edgelist/%s.txt',cell), 'Delimiter', '\t', 'WriteVariableNames',0);
    end
end