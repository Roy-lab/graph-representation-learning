function Get_Unweighted_Edgelist_Names()
    ...
    for i = 1:length(cells)
        ...
        edgelist=importdata(sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/edgelist/%s_no_weight.txt',cell));
        edgelist = arrayfun(@num2str,edgelist,'un',0);
        nodeNames=readtable(sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/adj_matrix/%s_nodeNames_no_weight.txt',cell));
        ...
        writecell(edgelist, sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/edgelist/edgelist_names/%s_no_weight.txt',cell), 'Delimiter', '\t');
    end
end