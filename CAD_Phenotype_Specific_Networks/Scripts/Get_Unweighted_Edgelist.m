function Get_Unweighted_Edeglist()
    ...
    for i = 1:length(cells)
        cell = cells{i};
        fprintf('%s\n', cell);
        adjmat=importdata(sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/adj_matrix/%s_no_weight.txt',cell));
        
        G = graph(adjmat~=0);
        edges = G.Edges; 
        writetable(edges, sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Cad/Data/edgelist/%s_no_weight.txt',cell), 'Delimiter', '\t', 'WriteVariableNames',0);
    end
end
