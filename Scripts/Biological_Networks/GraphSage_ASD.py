...
for mux in [0.5]:
    for k in [100]:
        for s in [1]:
            data = pd.read_csv("Data/edgelist/cd19.edgelist", delimiter = "\t", header = None)
            data.columns = ['source', 'target']
            #print(data)

            nodeid = pd.read_csv("Data/adj_matrix/cd19_nodeNames.txt", delimiter = "\t", header = None)
            ...
            with open("Results/embeddings/graphsage_64d_stellargraph/cd19_features.emb", "w") as f:
