...
for mux in ['0.1', '0.5']:
    for k in ['10', '25', '50', '100']:
        for i in ['1', '2', '3', '4', '5']:
          node_x, node_mapping = load_node_csv("/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/Simulated_Networks/Data/t1_2_t2_1_muw_{}/k_{}/network_{}_no_weight.dat".format(mux, k, i), index_col='source')
          data = Data()
          data.x = node_x
          print(data)
          edge_index = load_edge_csv_noweight("/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/Simulated_Networks/Data/t1_2_t2_1_muw_{}/k_{}/network_{}_no_weight.dat".format(mux, k, i), x_mapping = node_mapping)
          print(edge_index)
          ...
          with open("/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/Simulated_Networks/Results/embeddings/graphsage_256d_100_epoch/t1_2_t2_1_muw_{}/k_{}/network_{}_features.emb".format(mux, k, i), "w") as f:
