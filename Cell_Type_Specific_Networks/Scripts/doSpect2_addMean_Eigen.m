...
for y = 1:length(filename)
    mat = importdata(sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Org/Data/adj_matrix/%s',filename{y}));
    disp(size(mat));
    cell = cells{y};
    disp(cells{y});
    ...
    for k=10:10
        ...
        writematrix(EV, sprintf('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Org/Results/embeddings/spectral_clustering/%s_10_spect_kmeans.txt', cell),'delimiter',',')
    end
end
