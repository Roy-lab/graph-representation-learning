...
for cell in cells:
    my_data = genfromtxt('/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Org/Data/adj_matrix/{}.txt'.format(cell), delimiter='\t')
    print(my_data.shape)
    ...
    ids = range(num_nodes)
    with open("/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/RoadMap_Networks_Org/Results/embeddings/gvae_{}d/{}_features.emb".format('256', cell), "w") as f:
