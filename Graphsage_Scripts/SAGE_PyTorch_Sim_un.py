...
for mux in ['0.1', '0.5']:
    for k in ['10', '25', '50', '100']:
        for i in ['1', '2', '3', '4', '5']:
          ...
          with open("/mnt/dv/wid/projects3/Roy-enhancer-promoter/Zhiwei_Work/Simulated_Networks/Results/embeddings/graphsage_256d_un/t1_2_t2_1_muw_{}/k_{}/network_{}_features.emb".format(mux, k, i), "w") as f:
